                          ...
                          >
                            ...
                            {selectedAvatar && (
                              <button
                                ...
                                onClick={async () => {
                                  try {
                                    // Si es imagen personalizada (base64), enviar como archivo
                                    if (selectedAvatar.image && selectedAvatar.image.startsWith('data:image')) {
                                      ...
                                      await avatarService.saveMyAvatar(formData);
                                    } else {
